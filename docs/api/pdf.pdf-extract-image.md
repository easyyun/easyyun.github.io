...
```shell
{
	...
	"code": "200",
	"data": {
		"file_url": ["http://static.easyyun.com/static/example/out/extract/four_pages_1.png","http://static.easyyun.com/static/example/out/extract/four_pages_2.png","http://static.easyyun.com/static/example/out/extract/four_pages_3.png"]
	},
	"code_msg": "请求成功"
}
```
