...
| input | String | 是 | 输入文件，可访问互联网url，比如 http://www.easyyun.com/static/example/files/1.docx  |
...
-d 'input=http://static.easyyun.com/static/example/files/1.docx'
```
...
```shell
{
	...
	"code": "200",
	"data": {
		"file_url": "http://static.easyyun.com/static/example/out/1.pdf"
	},
	"code_msg": "请求成功"
}
```
